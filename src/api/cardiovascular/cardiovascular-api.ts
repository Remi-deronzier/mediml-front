...
export type CardiovascularPredictionDto =
  (typeof CardiovascularPredictionDto)[keyof typeof CardiovascularPredictionDto];
...
export const indexGet = (
  ...
  return cardiovascularApiInstance<IndexGet200>(
    { url: `/`, method: 'get' },
    options
  );
};
...
export type PredictPredictPostResult =
  AxiosResponse<CardiovascularPredictionsDto>;
